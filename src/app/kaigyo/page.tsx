        ...
        <section className={sectionClass}>
          ...
          <div className="space-y-5">
            ...
            <div>
              ...
              <input type="text" id="kaigyo-nameKana" name="nameKana" value={form.nameKana}
