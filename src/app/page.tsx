...
const FAQ_ITEMS: { q: string; a: string }[] = [
  ...
  {
    q: "どんな書類が作れますか？",
    a: "書類作成は8種類に対応しています。米の販売届出・青色申告・農業者年金・補助金（経営所得安定対策）の申請・農地の届出・専従者給与の届出・開業届、そして開業時に必要な書類をまとめて作れる「開業3点セット」です。ほかに、収支の記帳・農薬肥料の使用記録・農作業日誌を記録できる無料ツールもご用意しています。",
  },
  {
