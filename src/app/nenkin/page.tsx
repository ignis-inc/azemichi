    ...
    <div className="min-h-screen bg-green-50">
      ...
      <nav className="max-w-2xl mx-auto px-4 pt-6">
        <div className="flex gap-3">
          <Link
            href="/"
            className="flex-1 text-center py-3 px-4 rounded-xl border-2 border-green-200 bg-white text-green-700 font-medium text-sm sm:text-base hover:border-green-400 hover:bg-green-50 transition-colors"
          >
            米穀販売届出書
          </Link>
